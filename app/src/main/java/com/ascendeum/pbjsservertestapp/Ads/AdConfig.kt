...
enum class AdPlacement {
    ...
    val config: AdUnitConfig
        get() = when (this) {
            SYMBOL_INSTREAM_1 -> AdUnitConfig("/22404395434/stocktwitsandroidapp/Symbol_InStream_Native", "2d60yfch", listOf(AdSize.MEDIUM_RECTANGLE, AdSize.BANNER, AdSize.FLUID))
            SYMBOL_INSTREAM_2 -> AdUnitConfig("/22404395434/stocktwitsandroidapp/Symbol_InStream_Native_2", "sckflmua", listOf(AdSize.MEDIUM_RECTANGLE, AdSize.BANNER, AdSize.FLUID))
            SYMBOL_INSTREAM_3 -> AdUnitConfig("/22404395434/stocktwitsandroidapp/Symbol_InStream_Native_3", "sbpwrpl5", listOf(AdSize.MEDIUM_RECTANGLE, AdSize.BANNER, AdSize.FLUID))
